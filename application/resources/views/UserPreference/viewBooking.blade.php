        ...
        <div class="booking-cmplet-sect">
            ...
            <div class="container">
            	...
            	<div class="bcmplt-head">
                    ...
                    <?php if($record->is_pending==1 && $record->booking_status != "canceled"){
                ...
                <div class="bcmplt-info">
                	...
                	<div class="bcmplt-info-left">
                        ...
                        <div class="booking-code">
                            ...
                            <span class="right-align"><?php if($record->is_pending==1 && $record->booking_status != 'canceled'){
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td align="right" width="15%">
                              ...
                              <span><?php if($record->is_pending==1 && $record->booking_status != 'canceled'){
