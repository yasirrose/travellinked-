...
<div class="booking_process" style="display:none;"> @include('layouts.process') </div>
<style>
    .staying-days > a {
        height: 34px;
    }
        ...
        <div class="paymentportal-sect">
            <div class="container">
                    ...
                    <div class="paymentportal-sect-left">
                        ...
                        <?php if(session()->get('userLogin') != 1){?>
                            <div class="payment-signin">
                                ...
                                <a href="{{url('userlogin')}}" class="login-link">Sign In</a>
                            </div>
                        <?php } ?>
                        <div class="payment-form traveler_information">
                            ...
                            @if($totalrooms>1)
                                ...
                                @foreach($dispRooms as $key => $value)
                                    ...
                                    ?>
                                    <div class="pform-row"> Room {{$i}} - {{$value['adultSearch']}}
                                        Adults, {{$value['childrenSearch']}}
                                        Children, {{$value['roomType']}} {{$value['bedType']}} </div>
                                    <div class="pform-row">
                                        <div class="pform-1 validated">
                                            <label>Title</label>
                                            <div class="icon-control">
                                                <select class="control-field valid" name="traveler_title{{$i}}"
                                                        required>
                                ...
                                <div class="pform-row">
                                    ...
                                    <div class="pform-2 validated">
                                        ...
                                        <input class="control-field valid" placeholder="Enter First Name" type="text"
                                               name="traveler_fname" value="{{session()->get('userName')}}">
                                        <div class="err">Please enter first name</div>
                                    </div>
                                    <div class="pform-2 validated">
                                        <label>Last Name</label>
                                        @if(isset($userLastName))
                                            <input class="control-field valid" placeholder="Enter Last Name" type="text"
                                                   name="traveler_lname" value="{{$userLastName->last_name}}"
                                                   required="required">
                                        @elseif(session()->get('lastName') != null)
                                            <input class="control-field valid" placeholder="Enter Last Name" type="text"
                                                   name="traveler_lname" value="{{session()->get('lastName')}}" required="required">
                                            @else
                                            <input class="control-field valid" placeholder="Enter Last Name" type="text"
                        ...
                        <div class="payment-form payment">
                            <div class="title_promo">
                                <h4>Payment</h4>
                                <ul class="card_list">
                                    <li><a href="#"><img src="{{url('/assets/images/card_01.png')}}" alt="card_01"></a>
                                    </li>
                                    <li><a href="#"><img src="{{url('/assets/images/card_02.png')}}" alt="card_02"></a>
                                    </li>
                                    <li><a href="#"><img src="{{url('/assets/images/card_03.png')}}" alt="card_03"></a>
                                    </li>
                                    <li><a href="#"><img src="{{url('/assets/images/card_04.png')}}" alt="card_04"></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card_info">
                        ...
                        <!--   <div class="payment-form payment member">
                            ...
                            <div class="payment-form terms_conditoin">
                                ...
                                <p>We understand that sometimes your travel plans change. we do not charge a change or
                                    cancel fee. However, this property ({{$hotel}}) impose the following penalty to its
                                ...
                                <div class="payment-signin reservation">
                                    ...
                                    <input type="hidden" name="apiRoomRate" id="apiRoomRate" value="{{$apiRoomRate}}">
                ...
                <div class="paymentportal-sect-right">
                    <div class="venue-img"><img style="height:120px; width:300px;" src="{{$image}}"></div>
                    <div class="trip_summary">
                        ...
                        <div class="venu-text box">
                            ...
                            ?>
                            <span>{{$value['roomType']}} {{$value['bedType']}}</span> <span>{{$value['adultSearch']}}
                                Adults, {{$value['childrenSearch']}} Children</span>
                            <?php } ?>
                        </div>
                        <div class="venu-text box">
                            <?php if($nights > 1){ ?>
                        ...
                        <div class="venu-text box">
                            ...
                            <div class="top_night_parent">
                                ...
                                <div class="right_excl"><span>${{$totalRate}}</span></div>
                            </div>
                            <div class="top_night_parent">
                                <div class="left_excl">
                                    <h5>With Tax</h5>
                                </div>
                                <div class="right_excl"><span>${{$actualTax}}</span></div>
                                <br/>
                            </div>
                            <div class="top_night_parent">
                                <?php if($hotel_fee > 0){ ?>
                            ...
                            <div class="top_night_parent bold">
                                ...
                                <div class="right_excl"><span>${{$grandTotal}}</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="total-amount">
                        <div class="top_night_parent">
                            ...
                            <div class="right_excl"><span>${{$grandTotal - $hotel_fee}}</span></div>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
