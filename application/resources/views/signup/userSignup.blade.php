	...
	<div class="become-member-right">
		<div class="become-member-right-inner">
			...
			<div class="become-member-fb">
				<a href="{{url('userlogin/facebook')}}"><span><i class="fa fa-facebook"></i></span>Join with Facebook</a>
			</div>
			...
			<div class="become-member-form">
				...
				<div class="signup-form-row">
					@if(isset($user_email))
					<input type="email" class="signup-form-field" name="user_email" id="usr_email" value="{{$user_email}}" >
					<input type="hidden" class="form-control" name="facebook_id" id="facebook_id" value="{{$user_id}}">
					@else
				...
				<div class="signup-form-row">
					@if(isset($fbname))
					<input  type="text" class="signup-form-field" name="first_name" id="frst_name" value="{{$fbname[0]}}" >
					@else
				...
				<div class="signup-form-row">
					@if(isset($fbname))
					<input type="text" class="signup-form-field" name="last_name" id="lst_name" value="{{$fbname[1]}}">
					@else
				...
				<div class="members-login-link">
					<span>Are you already a member? <a href="{{'userlogin/simple'}}">Log in</a></span>
				</div>
			</div>
		</div>
	</div>
            ...
            $.ajax({
                ...
                success:function (data) {
                    if (data==1) {
                        ...
                        window.location.href = '{{url('userlogin/facebook')}}';
                    }
                }
            })
		}
