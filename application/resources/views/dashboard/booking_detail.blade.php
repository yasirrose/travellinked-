...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="content-heading"> <em class="fa fa-check-square-o"></em>   <span class="admin-breadcrumb">  <a href="#">  Bookings </a>  / </span><span>   #{{$bookingDetail->request_id}}</span>
        ...
        <div class="row booking-detail-wrap">
            <div class="col-lg-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <input id="notedID" type="hidden" value="{{$bookingDetail->request_id}}">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td>{{Carbon\Carbon::parse($bookingDetail->booking_traveldate)->format('F jS  Y')}}
                                    - {{Carbon\Carbon::parse($bookingDetail->booking_traveldateEnd)->format('F jS  Y')}}</td>
                                <td>Credit Card</td>
                                <td>Website</td>
                        ...
                        <div class="col-md-6 pull-right">
							...
							<div class="text-right">
								...
								<a href="{{url('admin/decline/'.$bookingDetail->user_id)}}">
								...
								<a href="{{url('admin/cancel/'.$bookingDetail->request_id)}}">
								<button class="btn btn-danger">Cancel</button>
								</a>
								<?php }elseif($bookingDetail->is_refunded == 0) { ?>
								<a href="{{url('admin/decline/'.$bookingDetail->request_id)}}">
								<button class="btn btn-primary">Refund</button>
								</a>
								<?php } ?>
							</div>	
			...
			<div class="col-md-4">
				<div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                    <h4>Customer <small class="pull-right"> {{$total_orders}} Orders</small></h4>
                    </div>
					<div class="panel-body">
                        <p><?php echo $user->fname . " " . $user->lname; ?></p>
						<p class="customer-category">Wholesaler</p>
						<p class="discount-content">Customer recieves {{ $user->discount }} % of Discount</p>
						
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4>Contact <small class="pull-right"><a class="Change-orders" href="{{url('admin/user/edit/'.$bookingDetail->user_id)}}">Change</a></small></h4>
					</div>
					<div class="panel-body">
                        ...
                        <h5><a class="user-num" href="tel:(305) 938-3000">{{$user->phone}}</a></h5>
				...
				<div class="panel panel-default panel-notes">
					<div class="chgform panel-heading">
						...
						<p id="bookingNotes">{{$bookingDetail->notes}}</p>
					</div>
				</div>				
