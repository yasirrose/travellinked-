...

{
...

	{
		...
		return view('dashboard.hotelGroup',compact('title'));
...

	{
		...
		return view('dashboard.facilitiesImport',compact('title'));
		...
		{	
...

			{
...

				{
					...
					$deal->BookingDateStart = $filesop[5];
					$deal->BookingDateEnd = $filesop[6];
					$deal->StayDateStart = $filesop[7];
					$deal->StayDateEnd = $filesop[8];
					...
					$deal->RFStartDate = $filesop[23];
					$deal->RFEndDate = $filesop[24];
...

	{
		...
		return view('dashboard.hotelswithcodes',compact('title'));
