            ...
            <div class="col-lg-12">
                ...
                <div id="panelDemo14" class="panel panel-default">
					...
					<div class="panel-body">		
                        ...
                        <input type="hidden" value="{{url('load_deals')}}?page=1" id="pageNumber">
                        <input type="hidden" value="{{url('load_deals')}}?page=2" id="pageNumber2">
...
@section('script')
    ...
    <script>
        ...
        function getValue(xyz){
            ...
            $('#datatable1').DataTable().ajax.url('{{url('admin/load_deals')}}?value='+filter_record_var).load();
        }
        $(document).ready(function () {
          ...
          var table =  $("#datatable1").dataTable({
                "bProcessing" : true,
                "sAjaxSource" :'{{url('admin/load_deals')}}?value='+filter_record_var,
    ...
    {{--<script>--}}
       ...
       {{--var a = element.classList.add("active");--}}
       {{--alert(a);--}}
    {{--</script>--}}
@endsection
