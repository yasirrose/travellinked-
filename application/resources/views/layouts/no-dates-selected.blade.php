    ...
    <div class="header-btm">
        ...
        <div class="container">
            ...
            <div class="hb-left">
                ...
                <div class="logo-main"> <a href="{{url('/')}}"><em>T</em>RAVEL <em>L</em>INKED</a> <span>Have a question? Call us at (000) 000-0000</span> </div>
            ...
            <div class="hb-right">
                    ...
                    <ul>
                        ...
                        <li> <a href="{{url('userlogin/simple')}}" class="login-link">Log In</a> </li>
                    ...
                    <?php }else{ ?>
                        <ul class="login-nav">
                            <li>
                                <a href="{{URL::to('user\reservations')}}">My Reservations</a>
                            </li>
                            <li>
                            ...
                            <div class="users-dropown-list">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a href="{{URL::to('user\password')}}">Password</a>
                                    ...
                                    <li>
                                        <a href="{{URL::to('user\billInformation')}}">Billing Information</a>
                                    </li>
                                    <li>
...
<div class="header-main header-sticky">
    ...
    <div class="header-btm header-search">
        ...
        <div class="container">
			...
			@include('frontend.no_dates_selected_sticky')
                    ...
                    <div class="users-dropown-list">
                        ...
                        <ul>
                            ...
                            <li class="signout-link">
                                ...
                                <a href="{{url('userlogin/simple')}}" class="login-link">Log In</a>
...
<script src="{{url('/assets/js/nodatesSelected.js')}}?v={{ uniqid() }}" type="text/javascript"></script>
