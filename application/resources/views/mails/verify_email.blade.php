        ...
        <td align="center" width="640">
            <table cellpadding="0" cellspacing="0" width="100%" align="center" bgcolor="#f4f4f4">
				...
				<tr>
                    <td width="20"></td>
                    <td align="center">
                            <a href="{{URL('verify_email/'.$data['code'])}}" style="display: inline-block; color: white; background: #8dcbca;border: 10px solid #8dcbca;font-weight: bold;border-radius: 4px; font-family:Arial, Helvetica, sans-serif; text-decoration:none;">Click to verify the account</a>
                    </td>
                    <td width="20"></td>
				</tr>	
                <tr>
