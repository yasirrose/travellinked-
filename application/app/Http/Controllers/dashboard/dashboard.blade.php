    ...
    <div class="content-wrapper">
      <div class="content-heading">
       ...
       <div class="panel panel-default">
            ...
            <form action="{{URL::to('/admin/addCustomer')}}" method="POST" class="form-horizontal">
            {{csrf_field()}}
                 ...
                 <div class="panel-body">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="panel-body">
                       ...
                       <div class="form-group">
                      <label class="col-lg-2 control-label">categorize customers to groups</label>
                         <div class="col-lg-10">
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-lg-2 control-label">Add existing tags:</label>
                         <div class="col-lg-10">
                            <span class="label label-info">Consumer</span>

                                  <span class="label label-info">Consumer Business</span>

                                  <span class="label label-info">Consumer Wholesale</span>

                                  <span class="label label-info">Consumer Referral</span>
                           </div>
                      </div>
