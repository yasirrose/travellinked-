...
<div class="header-main">
   <?php
    ...
    <div class="header-btm">
        <div class="container">
            <div class="hb-left">
                <div class="logo-main"> <a href="<?php echo e(url('/')); ?>"><em>T</em>RAVEL <em>L</em>INKED</a> <span><a href="callto:000-000-0000">Have a question? Call us at (000) 000-0000</a></span></div>
            </div>
            <div class="hb-right">
                    <?php if(empty(session()->get('userLogin')) || session()->get('userLogin') == 0){ ?>
                        <ul>
                           <li> <a href="<?php echo e(url('userlogin/simple')); ?>" class="login-link">Log In</a>
                            <li class="sign-in signup-link"> <a href="<?php echo e(url('signup')); ?>">Sign Up</a> </li>
                        </ul>
                    <?php }else{ ?>
					<ul class="login-nav">
                    	<li><a href="<?php echo e(URL::to('user\reservations')); ?>">My Reservations</a></li>
                            ...
                            <div class="users-dropown-list">
                            	<ul>
                                	<?php if(intval(session()->get('userStatus')) == 0){ ?>
                                	    <li><a href="<?php echo e(url('resend-confirmation')); ?>">Activate Account</a></li>
                                    <?php } ?>
                                	<li><a href="<?php echo e(URL::to('user\profile')); ?>">Your Profile</a></li>
                                    <li><a href="<?php echo e(URL::to('user\travelers')); ?>">Travelers</a></li>
                                    <li><a href="<?php echo e(URL::to('user\trip')); ?>">Trip Settings</a></li>
                                    <li><a href="<?php echo e(URL::to('user\password')); ?>">Password</a></li>
                                    <li><a href="<?php echo e(URL::to('user\reservations')); ?>">Your Reservations</a></li>
                                    <li><a href="<?php echo e(URL::to('user\billInformation')); ?>">Billing Information</a></li>
                                    <li><a href="<?php echo e(URL::to('user\History')); ?>">History</a></li>
                                    <li class="signout-link"><a href="<?php echo e(URL::to('/user_logout')); ?>">Sign Out</a></li>
                                </ul>
                            </div>
                        </div>
                       <!-- user-list-->
...
if($page != "no/inventory" && !(in_array('payment',$pageArr))){ ?>
	<?php echo $__env->make('frontend.stickyheader', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php } ?>
...
<script src="<?php echo e(url('/assets/js/roomsScript.js')); ?>?v=<?php echo e(uniqid()); ?>" type="text/javascript"></script>
<script src="<?php echo e(url('/assets/js/script.js')); ?>?v=<?php echo e(uniqid()); ?>" type="text/javascript"></script>
...
<?php if(in_array('payment',$pageArr)){ ?>
    ...
    <script src="<?php echo e(url('/assets/js/payment.js')); ?>?v=<?php echo e(uniqid()); ?>" type="text/javascript"></script>
<?php } ?>
