<?php $__env->startSection('content'); ?>
            ...
            <div class="search-container">
                ...
                <div class="results-top-sect">
                    ...
                    <div class="rt-left">
                        ...
                        <h4><?php echo e(session()->get("destination")); ?></h4>

                        <p id=""><?php echo e($total_result); ?> Deals found</p>

                        <input type="hidden" id="totalDeals" value="<?php echo e($total_result); ?>"/>
                        ...
                        <div class="row search-module-container">
                                        ...
                                        <div class="share-dropdown-body">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="mailto:?<?php echo e($mailurl); ?>" class="email-link">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="http://www.facebook.com/sharer.php?<?php echo e($fburl); ?>" target="_blank" class="fb-link">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="https://twitter.com/share?<?php echo e($twitterurl); ?>" target="_blank" class="twtr-link">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="https://plus.google.com/share?<?php echo e($gplusurl); ?>" target="_blank" class="google-link">
                                            ...
                                            <div class="share-copylink">
                                                ...
                                                <input type="text" value="<?php echo e(Request::fullurl()); ?>" readonly="readonly">
                            ...
                            <div class="tabs-content">
                                ...
                                <div class="tab-container filter-data" id="tab1">
                                    ...
                                    <div class="hotel-desp-box common-srch satr-num-<?php echo e(floor($arr[0])); ?>star <?php echo e($Hotels['hotelCode']); ?>" id="s-<?php echo e($arr[0]); ?>star">
                                        ...
                                        <div class="hotel-desp">
                                            ...
                                            <span class="hotel-rating <?php echo e($class); ?>"> <?php echo $rating; ?> </span>
                                                ...
                                                <div class="left-align">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="<?php echo e(url('/rooms')); ?>?hotel=<?php echo e($Hotels['hotelCode']); ?>">Overview</a>

                                                        </li>

                                                        <li>

                                                            <a href="<?php echo e(url('/rooms')); ?>?hotel=<?php echo e($Hotels['hotelCode']); ?>">Room Details</a>
    ...
    <div id="infscr-loading" style="display: none;">
        ...
        <img alt="Loading..." style="width:50px; height:50px;" src="<?php echo e(url('assets/images/loader.gif')); ?>">

        <div style="opacity: 1;" id="textMsg">Loading...</div>

    </div>

    <div id="maxPrice" class="<?php echo e($maxPrice); ?>" style="display:none;"></div>
    <?php
    if(isset($minPrice)){ ?>

    <div id="minPrice" class="<?php echo e($minPrice); ?>" style="display:none;"></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.inner_main', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>