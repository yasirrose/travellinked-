...
<div class="header-main">
    <div class="header-btm header-search">
        <div class="container">
            <div class="hb-left">
                <div class="logo-main"> <a href="<?php echo e(url('/')); ?>"><em>T</em>RAVEL <em>L</em>INKED</a> </div>
            </div>
            <div class="hb-center">
    ...
    <a href="javascript:void(0);" id="scroll" title="Scroll to Top" style="display: none;"><i class="icon ion-ios-arrow-thin-right"></i><span></span></a>
</div>
