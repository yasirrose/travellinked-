    ...
    <div class="container">
		...
		//	$stateSlug = str_replace(' ','-',$singDealx->name);
            ...
            <div class="image-product">
            	...
            	<a href="<?php echo e(url('viewHotel').'/'.$citySlug.'/'.$singDealx->hotelCode); ?>">
			...
			//	$stateSlug = str_replace(' ','-',$hotel->state);
			  ...
			  ?>
                ...
                <div class="one-third">
                	...
                	<a href="<?php echo e(url('viewHotel').'/'.$citySlug.'/'.$hotel->hotelCode); ?>">
                ...
                <div class="grid">
                    ...
                    <div class="grid-item <?php echo $dest['layout'] ?>" <?php echo $dest['extra'] ?>>
                        ...
                        <div class="masonry-box">
                        	...
                        	<a href="<?php echo e(url('destinations').'/'.$dest['hotelgroupcode'].'/'.str_replace(' ','-',$dest['hotelgroupname'])); ?>">

                        	<?php if(empty($dest['hotelgroupimage'])){ ?>

                            <img src="<?php echo e(url('assets/dashboard/images/destinations/default.jpg')); ?>" <?php echo $dest['style'] ?>>

                            <?php }else{ ?>

                            <img src="<?php echo e(url('/').'/'.$dest['hotelgroupimage']); ?>" <?php echo $dest['style'] ?>>
...
//										}
                                        ...
                                        <li>
                                            ...
                                            <a href="<?php echo e(url('viewHotel').$urlString); ?>">
		...
		//	$stateSlug = str_replace(' ','-',$deal->state);
            ...
            <div class="one-third">
                ...
                <a href="<?php echo e(url('viewHotel').'/'.$citySlug.'/'.$deal->hotelCode); ?>">
