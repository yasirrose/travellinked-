        ...
        <div class="booking-cmplet-sect">
            <div class="container">
                <div class="bcmplt-head">
                    ...
                    <p>Confirmation emailed to
                        to <?php echo e($travelDetail->traveler_email); ?></p> <?php } ?>
                    <ul>
                ...
                <div class="bcmplt-info">
                    <div class="bcmplt-info-left">
                        <div class="btn-aright">
                            ...
                            <span class="hotel-rating four-star"><?php echo e($realStar[2]); ?></span>
                        </div>
                        <div class="booking-code">
                            <span class="left-align">Booking Status</span>
                            <span class="right-align"><?php echo e($bookingDetail->booking_status); ?></span>
                        </div>
                    </div>
                    ...
                    <table cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td align="right" width="15%"><h5>Vendor Confirmation #</h5>
                                 <?php if($room_booking->status == 'canceled'): ?>
                                <span> <?php echo e($room_booking->status); ?></span></td>
                                <?php else: ?>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="24%"><h5>No. of Nights</h5>
                                <span><?php echo e($nights); ?></span></td>
                ...
                <div class="bcmplt-row">
                    <div class="total-chagebox"><h5>Charges</h5>
                        ...
                        <div class="charge-list"><span class="left-align">Hotel Fees (due at hotel)</span> <span
                                    class="right-align">$<?php echo e($bookingDetail->hotelFee); ?></span>
