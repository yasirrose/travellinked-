<div class="engine-dropdown" id="horiz-box-rooms">
    ...
    <div class="engine-dropdown-row engine-dropdown-row-rooms" <?php echo $style ?>>
        ...
        <div class="rows-3">
            ...
            <div class="engine-dropdown-rooms">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field" id="horiz_rooms" name="horizRooms">
            ...
            <div class="engine-dropdown-adults">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field horiz-adults-rooms" id="adultrooms-<?php echo $i ?>" name="adults_<?php echo $i ?>">
            ...
            <div class="engine-dropdown-children">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field total_children horiz-child-rooms" name="children_<?php echo $i ?>" id="total_child_rooms<?php echo $i ?>">
        ...
        <div class="chldr-age-row total_child_rooms<?php echo $i ?>_ages" <?php echo $childAgeStyle ?>>
            ...
            <div class="age-select-boxes">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field" name="children_<?php echo $i ?>_age_1" <?php echo $curAges[0]['style'] ?> id="childrooms_<?php echo $i ?>_ages_1">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field age-2" name="children_<?php echo $i ?>_age_2" <?php echo $curAges[1]['style'] ?> id="childrooms_<?php echo $i ?>_ages_2">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field age-3" name="children_<?php echo $i ?>_age_3" <?php echo $curAges[2]['style'] ?> id="childrooms_<?php echo $i ?>_ages_3">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field age-4" name="children_<?php echo $i ?>_age_4" <?php echo $curAges[3]['style'] ?> id="childrooms_<?php echo $i ?>_ages_4">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field age-5" name="children_<?php echo $i ?>_age_5" <?php echo $curAges[4]['style'] ?> id="childrooms_<?php echo $i ?>_ages_5">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field age-6" name="children_<?php echo $i ?>_age_6" <?php echo $curAges[5]['style'] ?> id="childrooms_<?php echo $i ?>_ages_6">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field age-7" name="children_<?php echo $i ?>_age_7" <?php echo $curAges[6]['style'] ?> id="childrooms_<?php echo $i ?>_ages_7">
                ...
                <div class="icon-control">
                    ...
                    <select class="control-field age-3" name="children_<?php echo $i ?>_age_8" <?php echo $curAges[7]['style'] ?> id="childrooms_<?php echo $i ?>_ages_8">
    ...
    <div class="engine-dropdown-btns">
        ...
        <button class="btn-addrow" id="addHorizRoom"><i class="icon ion-plus-round"></i> Add Room</button>

        <button class="btn-cnfrm" id="confirmHorizRoom">Confirm</button>
