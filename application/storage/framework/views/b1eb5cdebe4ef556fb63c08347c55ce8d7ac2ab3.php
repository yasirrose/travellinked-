...
<script type="text/javascript">
    ...
    function getValue(xyz){
        ...
        $('#AllCustomersList').DataTable().ajax.url('<?php echo e(url('admin/users')); ?>?value='+filter_record_var).load();
    ...
    $(document).ready(function () {
        ...
        var table =  $("#AllCustomersList").dataTable({
            "bProcessing" : true,
            "sAjaxSource" : "<?php echo e(url('admin/users')); ?>?value="+filter_record_var,
...
function getFilteredRecords(tabName){
      $.ajax({
        url: "<?php echo e(URL('admin/users/getFilteredRecords')); ?>",
        type: "POST",
        data:{
          "Filter" : tabName,
...
function deleteuser(id) {
    ...
    $.ajax({
        url: "<?php echo e(URL('/admin/users/deleteuser')); ?>",
        type: "POST",
        data:{
            "id":id,
            "_token": "<?php echo e(csrf_token()); ?>"
...
<?php /*<script>*/ ?>
    ...
    <?php /*element.classList.add("active");*/ ?>
<?php /*</script>*/ ?>
<?php $__env->stopSection(); ?>
