...
<form action="<?php echo e(url('changeSearch')); ?>" method="get" class="sticky-form">
    ...
    <div class="staying-days">
        ...
        <input type="text" placeholder="Check In" id="datepicker_in_sticky" name="checkin" autocomplete="off" value="<?php echo e(session()->get('checkin')); ?>" class="control-field">

        <div class="sticky_tooltip_in" style="display:none;"></div>

        <span class="check-arrow"> <i class="icon ion-ios-arrow-thin-right"></i> </span>

        <input type="text" placeholder="Check Out" id="datepicker_out_sticky" name="checkout" autocomplete="off" value="<?php echo e(session()->get('checkout')); ?>" class="control-field">
