...
<script type="text/javascript">
    ...
    function getValue(xyz){
        ...
        $('#dtable').DataTable().ajax.url('<?php echo e(url('admin/bookings_details')); ?>?value='+filter_record_var).load();
    }
    ...
    $(document).ready(function () {
        var table =  $("#dtable").dataTable({
            "bProcessing" : true,
            "sAjaxSource" : "<?php echo e(url('admin/bookings_details')); ?>?value="+filter_record_var,
...
function getdelete(id) {
        $.ajax({
            url: "<?php echo e(URL('/admin/delete_booking')); ?>",
            type: "POST",
            data: {
                "id": id,
