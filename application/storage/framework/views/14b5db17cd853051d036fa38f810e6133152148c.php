            ...
            <div class="container">
                ...
                <ul class="rooms-topbar-social">
                    ...
                    <li>
                        ...
                        <a class="f-xs" href="mailto:?<?php echo e($mailurl); ?>">
                    ...
                    <li>
                        ...
                        <a class="f-sm" href="http://www.facebook.com/sharer.php?<?php echo e($fburl); ?>" target="_blank">
                    ...
                    <li>
                        ...
                        <a href="https://twitter.com/share?<?php echo e($twitterurl); ?>" target="_blank">
                    ...
                    <li>
                        ...
                        <a href="https://pinterest.com/pin/create/button/?<?php echo e($pinurl); ?>" target="_blank">
                    ...
                    <li>
                        ...
                        <a class="f-sm" href="https://plus.google.com/share?<?php echo e($gplusurl); ?>" target="_blank">
                        ...
                        <div class="caption">
                            ...
                            <div class="right-caption">
                                ...
                                <div class="top_bttn_nowp payment-signin">
                                    <?php foreach($minDeal as $key => $room): ?>
                                    <?php foreach($newsrate as $itemRate): ?>
                                    <?php 
                            ...
                            <div class="roomSearchBar">
                                ...
                                <div class="pform-1 checkin">
                                    ...
                                    <div class="icon-control">
                                        ...
                                        <input type="text" id="check_in" name="checkinRoomPage" autocomplete="off" class="control-field" placeholder="mm/dd/yyyy" value="<?php echo e(Session::get('checkin')); ?>" required="required">
                                ...
                                <div class="pform-1">
                                    ...
                                    <div class="icon-control">
                                        ...
                                        <input type="text" id="check_out" name="checkoutRoomPage" autocomplete="off" class="control-field" placeholder="mm/dd/yyyy" value="<?php echo e(Session::get('checkout')); ?>" required="required">

                                        <span class="ion ion-arrow-down-b"></span>

                                        <div class="main_tooltip" style="display:none;"></div>

                                        <input type="hidden" name="nightsRoomPage" id="nightsRoomPage" value="<?php echo e(Session::get('nights')); ?>" />
